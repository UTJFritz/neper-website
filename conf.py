...
version = 'version 4.1.1 (24 Nov 2020)'
...
latex_documents = [
  ('index', 'Neper.tex', u'Neper Documentation',
   u'Romain Quey', 'manual'),
]
...
man_pages = [
    ('index', 'neper', u'Neper Documentation',
     [u'Romain Quey'], 1)
]
...
texinfo_documents = [
  ('index', 'Neper', u'Neper Documentation',
   u'Romain Quey', 'Neper', 'One line description of project.',
   'Miscellaneous'),
]
